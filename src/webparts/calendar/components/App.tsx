...
// Declarations
const calandarIcon = require("../../../ExternalRef/icons/calendar@2x.png");
...
const data = [
  {
    ...
    month: "Nov",
    time: "10:30 - 11:30",
    message: "Meeting With CPC Member In Face To Face Mode",
  },
  {
    date: "04",
    month: "Sep",
  ...
  return (
    <div>
      <div className={`${styles.mainContainer}`}>
        ...
        {/* filter Section */}
        <Select variant="outlined" className={`${styles.filterSection} filterInput`}>
          <MenuItem value={1}>03/10/2022</MenuItem>
          <MenuItem value={2}>28/09/2022</MenuItem>
          <MenuItem value={3}>006/05/2021</MenuItem>
        </Select>
        {/* Calandar section */}
        <div className={styles.boxContainer}>
          {data.map((value) => {
            return (
              <div className={`${styles.boxFlex} boxBtnStyle`}>
                <Button
                  style={{ width: "100%" }}
                ...
                >
                  <div className={styles.box}>
                    <div className={styles.leftSideContainer}>
                      <div className={styles.leftSideFlex}>
                        <span>
                          {value.date} <br /> <span style={{fontWeight:100,fontSize:'22px'}}>{value.month}{" "}</span> 
                        </span>
                        <p>{value.time} </p>
                      </div>
                    </div>
      ...
      >
        <div className={`${styles.modalAlign} modalForm`}>
            ...
            <div className={styles.formHeader} style={{ fontSize: "10px" }}>
              ...
              <div className={styles.headerLine}> </div>
                  ...
                  <div className={styles.formFlex}>
                    ...
                    >
                      ...
                      <Select
                        ...
                        onChange={(data) => {
                          ...
                          modArrType = arrType.filter(
                            (row) => row.type == selRevData
                          );
                      ...
                      >
                        {arrReview != undefined &&
                          arrReview.map((row) => {
                            return (
                              <MenuItem value={row.text}>{row.text}</MenuItem>
                            );
                          })}
                      </Select>
                    ...
                    {/* Employee section */}
                    <div className= 
                      {`${styles.formContainer} employeeInput`}
                      style={{ width: "30%" }}
                    >
          ...
          <div style={{ width: "100%" }}>
            <div className={styles.formHeader} style={{ fontSize: "10px" }}>
              <div className={styles.headerContent}> Details Informations</div>
              <div className={styles.headerLine}> </div>
            </div>
          </div>
        </div>
                  ...
                  >
                    ...
                    {/* Date sections */}
                      ...
                      <div
                        ...
                        style={{ width: "20%" }}
                      >
                        <InputLabel htmlFor="datetime-local">
                          End date
                        </InputLabel>
                        <TextField
                          variant="outlined"
                          ...
                          className={styles.inputsm2}
                          defaultValue={
                            formDatas.EndDate ? formDatas.EndDate : null
                          }
                          onChange={(data) => {
